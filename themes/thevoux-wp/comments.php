...
<div class="commentlist_parent">
	<a href="#" id="comment-button">
		<?php echo thb_get_comments_number_str(); ?>
	</a>
...
'url'    => '<div class="small-12 columns"></div></div>' ) ),
		
	
		
'comment_field' => '<div class="row"><div class="small-12 columns" style="display:none;"><textarea name="comment" id="comment"' . $aria_req . ' rows="10" cols="58" placeholder="' . __( 'Your Comment', 'thevoux' ) . '"></textarea></div></div>',	

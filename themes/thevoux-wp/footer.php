...
<div id="thbSelectionSharerPopover" class="thb-selectionSharer" data-appid="<?php echo ot_get_option('selection_sharing_appid'); ?>" data-user="<?php echo $twitter_user; ?>">
...
<?php 
	 ...
	 */
	 wp_footer(); 
?>
<script type="text/javascript" src="http://togglehead.net/ntic/wp-content/themes/thevoux-wp/assets/js/masonry.pkgd.min.js"></script>
<script type="text/javascript" src="http://togglehead.net/ntic/wp-content/themes/thevoux-wp/assets/js/simple-lightbox.js"></script>
<script type="text/javascript" src="http://togglehead.net/ntic/wp-content/themes/thevoux-wp/assets/js/custom.js"></script>
</body>
</html>
